...
# Inference on CAIDA dataset (word2vec embeddings) to generate synthetic data with saved model from train script.
...
OUT_DATA="${REPO}/path/to/${NAME}_syn.csv"
